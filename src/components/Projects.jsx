       ...
       <h2 id="projects" className='font-semibold text-2xl lg:text-[32px] text-primary-blue'>
        ...
        <div className="flex flex-col gap-4.5 items-center sm:items-start lg:grid bigscreen:grid-cols-2 lg:gap-10">
         {projects.map(project => (
            ...
            sm:flex-row sm:gap-5 sm:border-2 sm:border-primary-blue sm:min-w-[542px] sm:max-w-[615px] sm:bg-white
            sm:rounded-3xl overflow-hidden sm:w-full"
            >
              <div>
                <img src={project.img} alt={project.name} 
                  className="w-37.5 h-22.5 rounded-2xl 
                   sm:w-63 sm:h-37 "
                />
              </div>
